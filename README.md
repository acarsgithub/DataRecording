...
We found that it is helpful to: 
 - **replace *test* with the folder destination that you want to save the PNG files to**. 
This is something we had to discover on our own, but a useful tool.
